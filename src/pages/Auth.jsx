...
export default function Auth() {
  ...
  const fieldClass = (field) =>
    `w-full h-14 px-5 rounded-2xl border outline-none focus:border-emerald-500 ${
      fieldErrors[field] ? 'border-red-400 dark:border-red-500' : 'border-gray-200 dark:border-gray-600 dark:bg-gray-900'
    }`;
        ...
        <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-[32px] p-8 shadow-xl border border-gray-200 dark:border-gray-700">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white dark:bg-gray-800 px-4 text-gray-400">or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full h-14 flex items-center justify-center gap-3 rounded-2xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold transition-all"
          >
